...
case $action in
    ...
    nohup java $JAVA_OPT -DSERVER_HOME=$SERVER_HOME -Djava.library.path=$JAVA_LIBRARY_PATH -classpath $CLASSPATH:$SERVER_HOME/server.jar com.j13.garen.poppy.starter.ServerStarter $SERVER_TMP 80 >>$SERVER_LOGS_OUT_FILE 2>&1 &
